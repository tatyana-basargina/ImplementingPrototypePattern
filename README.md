...
- Написать вывод: какие преимущества и недостатки у каждого из интерфейсов: IMyCloneable и ICloneable.
	...
	- IMyCloneable:
		- преимущества:
			- сохранение типа объектов при клонировании
			- тип клонирования выбирается соответствующим методом
		- недостатки:
	...
	- ICloneable:
		- преимущества:
			- стандартный
			- минимальная реализация для базового клонирования
			- совместимость
		- недостатки:
			- необходимость приведения типов
			- не указывается тип клонирования (глубокое или поверхностное клонирование)
			- не поддерживает джененрики